...
--
-- Host: localhost
-- Generation Time: Feb 18, 2025 at 01:14 AM
...
(3, '0001_02_18_002829_create_spps_table', 1),
(4, '0001_02_18_003142_create_kelas_table', 1),
(5, '0002_01_01_000000_create_users_table', 1),
(6, '2025_02_18_005102_create_petugas_table', 1),
(7, '2025_02_18_010306_create_pembayarans_table', 1);
...
CREATE TABLE `pembayarans` (
  ...
  `jumlah_bayar` decimal(11,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `users`
  ...
  ADD KEY `users_id_spp_foreign` (`id_spp`);
...
--
ALTER TABLE `pembayarans`
  ADD CONSTRAINT `pembayarans_id_petugas_foreign` FOREIGN KEY (`id_petugas`) REFERENCES `petugas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `pembayarans_id_spp_foreign` FOREIGN KEY (`id_spp`) REFERENCES `spps` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_id_kelas_foreign` FOREIGN KEY (`id_kelas`) REFERENCES `kelas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `users_id_spp_foreign` FOREIGN KEY (`id_spp`) REFERENCES `spps` (`id`) ON DELETE CASCADE;
COMMIT;
